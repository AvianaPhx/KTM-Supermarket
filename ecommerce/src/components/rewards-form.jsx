...
const Rewardsform = () => {
    return (
        <>
            ...
            <div class="mb-4 max-w py-10 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <label for="email" className="block mb-2 text-sm font-bold text-gray-900 dark:text-white">Join our Family.</label>
                ...
                <p id="helper-text-explanation" className="mt-2 text-sm text-gray-500 dark:text-gray-400">Be first to know and take advantage of our amazing offers.</p>
            </div>
