...
const Rewardsform = () => {
    return (
        <>
            ...
            <div className="mb-1">
            <div className="max-w py-10 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            <label htmlFor="email" className="block mb-2 text-sm font-bold text-gray-900 dark:text-white text-center">Join our Family.</label>
