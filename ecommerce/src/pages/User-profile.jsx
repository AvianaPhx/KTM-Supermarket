const UserProfile_Edit = () => {
    return (
        <>
            <div className=" border p-32 m-10 w-5/12 justify-self-center">
                <h1 className="items-center mb-5 font-bold ">Edit your details</h1>
                <div>
                    ...
                    <form className="max-w-md mx-auto">
                        ...
                        <div className="max-w-lg mx-auto mb-5">
                            <label className="block mb-5 text-sm font-medium text-gray-900 dark:text-white" htmlFor="user_avatar">Upload profile</label>
...
/* <div classNameName="flex flex-row w-full justify-center">

               <div classNameName=" border p-32 m-10 w-5/12">
               <h1 classNameName="font-bold p-2">Full Name : </h1>
               <textarea classNameName="h-10">Name</textarea>
